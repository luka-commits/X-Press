...
/**
 * VersandStatus filter options (includes "all" for UI)
 */
type VersandStatusFilter = "all" | "offen" | "versandbereit";
...
export function VersandOrderList() {
  ...
  const fetchOrders = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/versand/orders?${params.toString()}`);
